...
import static io.github.esipovmatvey.rangerclickhousesync.engine.PolicyTransformer.*;
...
public class ClickHouseClient {
     ...
     * Роли идентифицируются по префиксу {@code ROLE_PREFIX}.
     *
     * @param id идентификатор политики
     */
    public void dropRolesByPolicyId(final Long id) {
        final String rolePrefix = ROLE_PREFIX + id + "_%";
     ...
     * Идентификация происходит по короткому имени {@code ROW_FILTER_PREFIX_<id>}.
     *
     * @param id идентификатор политики
     */
    public void dropRowPoliciesByPolicyId(final Long id) {
        final String rowPolicyName = ROW_FILTER_PREFIX + id;
     ...
     * Представления имеют имена {@code MASK_FILTER_PREFIX_<id>}.
     *
     * @param id идентификатор политики
     */
    public void dropMaskViewsByPolicyId(final Long id) {
        final String viewPrefix = MASK_FILTER_PREFIX + id;
        final List<String> dropSqls = jdbcTemplate.query(
